...
HTML-Page ist in [`lib/sunset-html.ts`](https://github.com/cx-mgmt/cx-o-nexredirect/blob/prod/lib/sunset-html.ts) — schwarz auf weiß, kein JS, kein externes Asset, kein Tracking. Funktioniert auch ohne JS-Browser.
